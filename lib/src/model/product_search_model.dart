...
//
//     final productSearchModel = productSearchModelFromMap(jsonString);
...
class ProductSearchModel {
  ...
  factory ProductSearchModel.fromJson(String str) =>
      ProductSearchModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ProductSearchModel.fromMap(Map<String, dynamic> json) =>
      ProductSearchModel(
        status: json["status"],
...
class Charge {
  ...
  factory Charge.fromJson(String str) => Charge.fromMap(json.decode(str));
